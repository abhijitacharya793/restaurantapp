    ...
    <>
      <div className="lg:max-w-screen-lg mx-auto py-20">
        <div className="flex flex-col items-center justify-center">
          <p className="w-18 py-1 border-t border-b border-yellow-600 text-sm font-light text-white">
            About Us
          </p>
          ...
          <div className="flex items-center w-full justify-center text-center text-white">
            ...
            array of multi-cuisine dishes that will ignite your taste buds. From
