...
export function Section2() {
  return (
    <>
      ...
      >
        {/* P1 */}
        <div className="lg:max-w-screen-lg mx-auto lg:flex items-center pt-32  ">
          <div className="w-1/3 lg:justify-start">
          ...
          <div className="w-1/3 lg:justify-center">
            <div className="flex text-left">
          ...
          <div className="w-1/3 lg:justify-end">
            <div className="flex text-left">
