    ...
    <>
      <div className="w-1/2 flex items-center">
        <div className="items-center text-left">
          <h1 className="text-6xl text-white app-header font-bold pt-32">
            Welcome to Restaurantate
          </h1>
          <p className="text-sm text-white pt-8 w-96">
      ...
      <div className="w-1/2 relative">
        ...
        <div className="flex absolute top-5 right-0 z-0 app-pattern">
          <img src="/pattern.svg" alt="home" className="justify-end w-64 h-64" />
        </div>
      </div>
    </>
  );
